...
为 `2efcf2810c1f215a02b19458fd5a565663d2f3bc`，image-lock recording commit 为
`9c121d5741798ebf9c97369eec83a900521b7840`。当前 source-bound 镜像已重建并记录，
其 source SHA256 labels 分别为 `f6fe3ab3938890e6d041df03bfd5857528c8e1269a631b38d6bbb527978c959d`
与 `cdb14db857668b50efd2cf3e1dfdfd9534dcd1041ca5a4988d391fac93a075c6`。当前证据与历史快照的边界见
[HANDOFF](HANDOFF.md)。
...
| Local-pilot image lock | Platform | `infra/local/images.lock.json` records Frappe/PWA inspect digest `sha256:0b0e24d7e25c2e384e977c1aa00ef8d032e54aadbb84af813fb077c58fd28460` at Frappe source `35beb25` and local-runtime inspect digest `sha256:61f2b48817983b82795542fdf0eb2cae3a27b8c637d23e71d34c265fb7d9fd8f` at runtime source `2efcf28` | Recorded local digests prove source-bound builds, not a formal Go, real-channel/model proof, terminal deletion approval, or production readiness; runtime evidence must be captured separately | [image lock](../infra/local/images.lock.json), [historical credential-free closure](evidence/user-identity-governance-closure/identity-governance-summary.md) |
