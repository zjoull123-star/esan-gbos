...
reference 为 `485d3def0ea30ee49a3899d71c10b0787ba0429f`，runtime source reference
为 `bb260632ff44c7065a88327f264612139a9070a2`，image-lock recording commit 为
`a599a5200e2a8e1b5e42301d74fe8d9d914161c4`。当前 source-bound 镜像已重建并记录，
其 source SHA256 labels 分别为 `441e33dec9acd744dd1b461ae49e950d18f764f05ae74e90357091a698320405`
与 `c23d41903977fb350764ceee8a21efad70ce1079a7b6eed4503a87af3ac37db3`。当前证据与历史快照的边界见
[HANDOFF](HANDOFF.md)。
...
| Formal local pilot composition | Platform/AI/Observer | Service topology and current-source images are recorded as `composition.status=composed`; current synthetic core has been restarted and is healthy; current-image live-site Playwright `test:e2e:site` at `http://127.0.0.1:58080` completed in `6.5s` with `4 passed, 21 skipped, 0 failed`; the 21 skipped scenarios are harness-only by design, so this is not all 25 live; formal preflight returns `rc78` solely because `local_pilot_go=false`; formal manifest remains `production_go=false`, `local_pilot_go=false` and channels/models/media/tunnel remain default-off | Real channels、provider API call/identity、fault drills、Kingdee、cloud 和 production remain unverified and No-Go；72-hour continuity is explicitly deferred and not an exit gate | [local-pilot manifest](../infra/local/local-pilot-manifest.json), [runtime entrypoints](../infra/local/runtime-entrypoints.json), [current runtime evidence](evidence/identity-resolution-runtime/identity-resolution-runtime-summary.md) |
| Local-pilot image lock | Platform | `infra/local/images.lock.json` records Frappe/PWA inspect digest `sha256:2a0440df614314dec036ecc934e37aa0b3713b8cb8610e3ca2bd8ed69f9187c2` at Frappe source `485d3def` and local-runtime inspect digest `sha256:de037ad28a020689fec8b72f743ad0224afdf5c2ca6856a2ea5568fabd45e568` at runtime source `bb260632` | Recorded local digests prove source-bound builds, not a formal Go, real-channel/model proof, or production readiness; runtime evidence must be captured separately | [image lock](../infra/local/images.lock.json), [current credential-free closure](evidence/user-identity-governance-closure/identity-governance-summary.md) |
