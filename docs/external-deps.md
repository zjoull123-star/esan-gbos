...
| MariaDB `11.8` image | Platform | Digest locked; health plus local backup/restore verified | Production backup, PITR and DR remain Gate 6 entry gates | [versions](compat/versions.json), [Gate 1](evidence/gate1-summary.md) |
| PostgreSQL 17 + pgvector `0.8.2` image | Data platform | Digest locked; Gate 3–5 schemas, forced RLS, migrations and local integration tests verified | Production HA, backup/PITR, retention and disaster recovery remain Gate 6 | [versions](compat/versions.json), [Gate 5](evidence/gate5/gate5-summary.md) |
...
| Gate 0/1 High/Critical exceptions | Security | 57 expiring entries / 103 exact PURLs; current exact Gate 5 image has 0 unwaived findings | Production Gate 5/6 remains blocked until remediation or independent production approval | [security exceptions](governance/security-exceptions-gate01.md), [Gate 5 security review](evidence/gate5/security-review.json) |
...
| Real AI/ASR model provider | AI governance | Deterministic Gate 4 agent and review path implemented; real provider not selected and real calls disabled | DPA, data-flow/redaction review, evaluations, budgets and formal approval remain external entry gates | [ADR-0004](adr/ADR-0004-ai-drafts-and-human-commands.md), [Gate 4](evidence/gate4/gate4-summary.md) |
